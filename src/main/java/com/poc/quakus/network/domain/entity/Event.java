...
import com.poc.quakus.network.domain.policy.RegexEventParser;
import com.poc.quakus.network.domain.policy.SplitEventParser;
import com.poc.quakus.network.domain.vo.Activity;
import com.poc.quakus.network.domain.vo.EventId;
import com.poc.quakus.network.domain.vo.ParsePolicyType;
import com.poc.quakus.network.domain.vo.Protocol;
