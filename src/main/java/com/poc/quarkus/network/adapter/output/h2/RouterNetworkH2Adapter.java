package com.poc.quarkus.network.adapter.output.h2;


import com.poc.quarkus.network.adapter.output.h2.data.RouterData;
import com.poc.quarkus.network.adapter.output.h2.mappers.RouterH2Mapper;
